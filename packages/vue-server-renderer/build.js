...
function runInVm (entry, files, _context) {
  if ( _context === void 0 ) _context = {};

  return new Promise(function (resolve, reject) {
    var context = createContext(_context);
    var res = evaluateModule(entry, files, context, {});
...
function createBundleRendererCreator (createRenderer) {
  return function (bundle, rendererOptions) {
    ...
    return {
      renderToString: function (context, cb) {
        ...
        runInVm(entry, files, context).catch(function (err) {
